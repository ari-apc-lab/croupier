...
class TestPlugin(unittest.TestCase):
    ...
    # -------------------------------------------------------------------------------
    @workflow_test(
        os.path.join('blueprints', 'pycompss-covid19-deploy', 'blueprint.yaml'),
        resources_to_copy=[
            (os.path.join('blueprints', 'pycompss-covid19-deploy', 'scripts', 'deploy.sh'), 'scripts'),
            (os.path.join('blueprints', 'pycompss-covid19-deploy', 'scripts', 'revert.sh'), 'scripts')
        ],
        copy_plugin_yaml=True,
        inputs='load_inputs', input_func_args='pycompss-covid19-deploy')
    def test_pycompss_covid19_deploy(self, cfy_local):
        self.run_test(cfy_local)

    # -------------------------------------------------------------------------------
    # ----------------------------- Covid19 cross platform --------------------------
    # -------------------------------------------------------------------------------
    @workflow_test(
        os.path.join('blueprints', 'pycompss-covid19-cross-platform', 'blueprint.yaml'),
        resources_to_copy=[
            (os.path.join('blueprints', 'pycompss-covid19-cross-platform', 'scripts', 'deploy.sh'), 'scripts'),
            (os.path.join('blueprints', 'pycompss-covid19-cross-platform', 'scripts', 'revert.sh'), 'scripts')
        ],
        copy_plugin_yaml=True,
        inputs='load_inputs', input_func_args='pycompss-covid19-cross-platform')
    def test_pycompss_covid19_cross_platform(self, cfy_local):
        self.run_test(cfy_local)
    ...
    @workflow_test(
        os.path.join('blueprints', 'multihpc-dm-monitoring', 'blueprint_multihpc_dm_monitoring.yaml'),
        copy_plugin_yaml=True,
